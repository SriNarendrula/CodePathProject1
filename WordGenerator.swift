...
class WordGenerator {
  ...
  static let possibleWords = ["AUDIO", "CRANE", "FRAME", "GLARE", "HOUSE", "IGLOO", "JUICE", "KOALA", "LEMON", "MANGO", "NIGHT", "OLIVE", "PEACH", "QUILT", "ROBOT", "SNAKE", "TIGER", "UMBRA", "VIOLA", "WHISK", "XENON", "YACHT", "ZEBRA"]
